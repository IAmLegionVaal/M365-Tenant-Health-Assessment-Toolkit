@{
    ...
    FunctionsToExport = @('New-M365Finding','Get-M365SeverityRank','Import-M365SyntheticData','Invoke-M365GraphCollection','Get-M365LiveData','New-M365HtmlReport','Invoke-M365Assessment')
    CmdletsToExport   = @()
    VariablesToExport = @()
    AliasesToExport   = @()
